 ...
 * 
 */
public class ActionListAvailableFolderAction extends AbstractControlledAction {

	private static final Log logger = LogFactory
			.getLog(ActionListAvailableFolderAction.class);

	public ActionListAvailableFolderAction() {
	}

	@Override
	public void execute(IProxy p, IParameterSource req, IResponder responder) {
		List<IFolder> list = p.getFolderService().listAvailableFolders();
		if (logger.isInfoEnabled()) {
			logger.info("available folders: " + list.size() + " results");
		}
