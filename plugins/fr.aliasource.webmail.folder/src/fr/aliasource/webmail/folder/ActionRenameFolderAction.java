...
public class ActionRenameFolderAction extends AbstractControlledAction {

	private Log logger;

	public ActionRenameFolderAction() {
	...
	public void execute(IProxy p, IParameterSource req, IResponder responder) {
		...
		logger.info("Rename folder "+folder.getName()+" to "+newName);
		p.getFolderService().renameFolder(folder,newName);

	}

	@Override
	public String getUriMapping() {
		return "/renameFolder.do";
	}
}
