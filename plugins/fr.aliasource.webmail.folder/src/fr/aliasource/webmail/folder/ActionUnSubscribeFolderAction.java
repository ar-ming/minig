 ...
 *
 */
public class ActionUnSubscribeFolderAction extends AbstractControlledAction {
	...
	public void execute(IProxy p, IParameterSource req, IResponder responder) {
		...
		logger.info("UnSubscribe to folder:"+folder.getName());
		p.getFolderService().unSubscribeFolder(folder);
	}

	@Override
	public String getUriMapping() {
		return "/unsubscribe.do";
	}
}
