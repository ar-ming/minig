...
public interface ILoadMessages {
	...
	MailMessage load(IFolder f, MessageId messageIds);
	MailMessage[] load(IFolder f, List<MessageId> messageIds);
	MailMessage[] load(IFolder f, List<MessageId> messageIds, boolean truncate);
