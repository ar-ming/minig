...
public class ForwardLoaderTests extends WebmailTestCase {
    ...
    while(it.hasNext()) {
      ...
      if (mm != null) {
        ...
        for (String attach : mm.getAttachements().keySet()) {
          System.out.println("\t"+mm.getAttachements().get(attach));
        }
        System.out.println("From : " + mm.getSender().getDisplayName());
        System.out.println("Date : " + mm.getDate().toString());
        System.out.println("text/plain : " + body.getValue("text/plain"));
        System.out.println("text/html : " + body.getValue("text/html"));
        System.out.println("-----");
