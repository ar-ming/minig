...
public class SubscribeMethod extends AbstractFolderMethod {

	private String token;

	public SubscribeMethod(HttpClient hc, String token, String backendUrl) {
		super(hc, backendUrl, "/subscribe.do");
		this.token = token;
	}
