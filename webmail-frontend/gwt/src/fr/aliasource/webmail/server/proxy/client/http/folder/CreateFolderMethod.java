...
public class CreateFolderMethod extends AbstractFolderMethod {

	private String token;

	public CreateFolderMethod(HttpClient hc, String token, String backendUrl) {
		super(hc, backendUrl, "/createFolder.do");
		this.token = token;
	}
