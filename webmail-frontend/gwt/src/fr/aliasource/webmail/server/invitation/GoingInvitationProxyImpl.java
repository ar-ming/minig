...
import fr.aliasource.webmail.server.calendar.CalendarProxyImpl;
 ...
 * 
 */
public class GoingInvitationProxyImpl extends HttpServlet {
	...
	public void init() throws ServletException {
		...
		backendUrl = prefs.get("frontend.proxyUrl") + "/goingEvent.do";
