...
package fr.aliasource.webmail.server.calendar;
...
/**
 * Proxies requests to backend calendar action
 * 
 * @author tom
 * 
 */
public class CalendarProxyImpl extends HttpServlet {

	private static final long serialVersionUID = -5058309430406865212L;

	@SuppressWarnings("unused")
	private static final Log logger = LogFactory
			.getLog(CalendarProxyImpl.class);
	...
	public void init() throws ServletException {
		...
		backendUrl = prefs.get("frontend.proxyUrl") + "/calendar.do";
